...
All you need to start receiving live information about orderbook is connect to **wss://altindex.org** and subscribe to necessary channel.
...
HTTP API endpoint available on https://altindex.org/api/v1/.
...
`GET https://altindex.org/api/v1/assets/`
...
request.get('https://altindex.org/api/v1/assets/', function (error, response, body) {
    // process response    
});
```
...
**HTTP Request**
`GET https://altindex.org/api/v1/pairs/`
...
request.get('https://altindex.org/api/v1/pairs/', function (error, response, body) {
    // process response    
});
```
...
`GET https://altindex.org/api/v1/wallets/`
...
request.get(
  'https://altindex.org/api/v1/wallets/',
  {
...
`GET https://altindex.org/api/v1/orderbook/<market>/`
...
var url = 'https://altindex.org/api/v1/orderbook/BTC_USD/';
...
`GET https://altindex.org/api/v1/orders/own/`
...
request.get(
  'https://altindex.org/api/v1/orders/own/',
  {
    headers: getAuthHeaders({})
  },
  function (error, response, body) {
...
`GET https://altindex.org/api/v1/order/<orderId>/`
...
var orderId = 12345;
request.get(
  `https://altindex.org/api/v1/order/${orderId}/`,
  function (error, response, body) {
    // process response    
  }
);
...
`POST https://altindex.org/api/v1/order/`
...
request.post({
    url: 'https://altindex.org/api/v1/order/',
    form: order,
...
`POST https://altindex.org/api/v1/order-cancel/`
...
request.post({
    url: 'https://altindex.org/api/v1/order-cancel/',
    form: order,
    headers: getAuthHeaders(order)
  }, function (error, response, body) {
    // process response
...
`GET https://altindex.org/api/v1/trades/`
...
request.get(
  'https://altindex.org/api/v1/trades/',
  function (error, response, body) {
    // process response    
  }
);
...
`GET https://altindex.org/api/v1/trades/own/`
...
request.get(
  'https://altindex.org/api/v1/trades/own/',
  {
    headers: getAuthHeaders({})
  },
  function (error, response, body) {
...
`GET https://altindex.org/api/v1/deposits/`
...
request.get(
  'https://altindex.org/api/v1/deposits/',
  {
    headers: getAuthHeaders({})
  },
  function (error, response, body) {
...
`GET https://altindex.org/api/v1/withdrawals/`
...
request.get(
  'https://altindex.org/api/v1/withdrawals/',
  {
    headers: getAuthHeaders({})
  },
  function (error, response, body) {
...
`GET https://altindex.org/api/v1/history/candles/<market>/<interval>/`
...
request.get({
    url: 'https://altindex.org/api/v1/history/candles/BTC_USD/60/'
  }
  function (error, response, body) {
    // process response    
  }
